...
export const IndividualStockTab = ({ stock, indexSelected, thisIndex, onClickContainer }) => (
  <div className={styles.cryptosContainer} onClick={(e) => { onClickContainer(thisIndex); }}>
